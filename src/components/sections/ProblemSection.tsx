      ...
      <div className="container px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            If you're leading a team of 5-20 people, you know these frustrations all too well. 
            And with limited training budgets, you can't afford another workshop that doesn't deliver.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {problems.map((problem, index) => (
            <div 
              key={index}
              className="group p-6 rounded-xl bg-background border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-medium"
